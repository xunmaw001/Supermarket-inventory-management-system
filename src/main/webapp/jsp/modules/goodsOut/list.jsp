...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        销售总价
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsOutMoneyStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsOutMoneyChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsOutMoneyEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsOutMoneyChickValue(this)"
                                                   placeholder="结束" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        商品阈值
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsYujingNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsYujingNumberChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsYujingNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsYujingNumberChickValue(this)"
                                                   placeholder="结束" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(goodsNumberEndSearchInput != null){
                ...
                if( goodsNumberEndSearchValue  != 0){
                    searchForm.goodsNumberEnd = goodsNumberEndSearchValue;
                                ...
                                //商品阈值
            var goodsYujingNumberStartSearchInput = $('#goodsYujingNumberStartSearch');
            if(goodsYujingNumberStartSearchInput != null){
                var goodsYujingNumberStartSearchValue = goodsYujingNumberStartSearchInput.val();
                if( goodsYujingNumberStartSearchValue  != 0){
                    searchForm.goodsYujingNumberStart = goodsYujingNumberStartSearchValue;
                }
            }
            var goodsYujingNumberEndSearchInput = $('#goodsYujingNumberEndSearch');
            if(goodsYujingNumberEndSearchInput != null){
                var goodsYujingNumberEndSearchValue = goodsYujingNumberEndSearchInput.val();
                if( goodsYujingNumberEndSearchValue  != 0){
                    searchForm.goodsYujingNumberEnd = goodsYujingNumberEndSearchValue;
                }
            }
            ...
            //销售总价
            var goodsOutMoneyStartSearchInput = $('#goodsOutMoneyStartSearch');
            if(goodsOutMoneyStartSearchInput != null){
                var goodsOutMoneyStartSearchValue = goodsOutMoneyStartSearchInput.val();
                if( goodsOutMoneyStartSearchValue  != 0){
                    searchForm.goodsOutMoneyStart = goodsOutMoneyStartSearchValue;
                }
            }
            var goodsOutMoneyEndSearchInput = $('#goodsOutMoneyEndSearch');
            if(goodsOutMoneyEndSearchInput != null){
                var goodsOutMoneyEndSearchValue = goodsOutMoneyEndSearchInput.val();
                if( goodsOutMoneyEndSearchValue  != 0){
                    searchForm.goodsOutMoneyEnd = goodsOutMoneyEndSearchValue;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("goodsOut/page", "GET", {
                ...
                goodsOutMoneyStart: searchForm.goodsOutMoneyStart,
                goodsOutMoneyEnd: searchForm.goodsOutMoneyEnd,
            //级联表的
                ...
                goodsYujingNumberStart: searchForm.goodsYujingNumberStart,
                goodsYujingNumberEnd: searchForm.goodsYujingNumberEnd,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(goodsNumberCell);
                        ...
                        //商品阈值
            var goodsYujingNumberCell = document.createElement('td');
            goodsYujingNumberCell.innerHTML = item.goodsYujingNumber;
            row.appendChild(goodsYujingNumberCell);
            ...
            //销售总价
            var goodsOutMoneyCell = document.createElement('td');
            goodsOutMoneyCell.innerHTML = item.goodsOutMoney;
            row.appendChild(goodsOutMoneyCell);
