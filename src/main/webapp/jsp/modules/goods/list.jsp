...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        是否阈值警告
                                        <div class="layui-input-inline">
                                            <select name="yuzhiSelect"  style="width: 150px;" id="yuzhiSelect" class="form-control form-control-sm"
                                                    aria-controls="tableId" >
                                                <option value="1">全部</option>
                                                <option value="2">阈值商品</option>
                                            </select>
                                        </div>
                                    </div>
    ...
    <!-- 本表的查询条件 -->
            ...
            //阈值商品
            var yuzhiSelect = document.getElementById("yuzhiSelect");
            if(yuzhiSelect != null){
                var yuzhiSelectIndex = yuzhiSelect.selectedIndex;
                if( ( document.getElementById("yuzhiSelect").options[yuzhiSelectIndex].value ) ==  2 ){

                    searchForm.yuzhiSelect= 2;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("goods/page", "GET", {
                ...
                yuzhiSelect: searchForm.yuzhiSelect,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //阈值警告
            var goodsNumberCell = document.createElement('td');
            if( (item.goodsNumber - item.goodsYujingNumber) <=0){
                goodsNumberCell.innerHTML = "阈值警告" ;
            }else{
                goodsNumberCell.innerHTML = "" ;
            }
            row.appendChild(goodsNumberCell);
            ...
            //整数
            function goodsYujingNumberChickValue(e){
                var this_val = e.value || 0;
                var reg=/^[0-9]*$/;
                if(!reg.test(this_val)){
                    e.value = "";
